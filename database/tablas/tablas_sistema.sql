...
BEGIN
    ...
    PRINT '✔️ Tabla tablas.ROLES creada.';
END
GO
...
BEGIN
    ...
    PRINT '✔️ Tabla tablas.CATEGORIAS creada.';
END
GO
...
BEGIN
    ...
    PRINT '✔️ Tabla tablas.UBICACIONES creada.';
END
GO
...
BEGIN
    ...
    PRINT '✔️ Tabla tablas.USUARIOS creada.';
END
GO

-- 2.5 PROPIEDADES
-- FIX: Incluye imagen_portada que fue agregada manualmente en producción
...
BEGIN
    CREATE TABLE tablas.PROPIEDADES (
        ...
        imagen_portada    NVARCHAR(500) NULL,  -- ← FIX: columna agregada para acceso rápido a portada
    ...
    PRINT '✔️ Tabla tablas.PROPIEDADES creada.';
END
ELSE
BEGIN
    -- Si la tabla ya existe, agregar imagen_portada si no tiene la columna (idempotente)
    IF NOT EXISTS (
        SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS 
        WHERE TABLE_SCHEMA = 'tablas' AND TABLE_NAME = 'PROPIEDADES' AND COLUMN_NAME = 'imagen_portada'
    )
    BEGIN
        ALTER TABLE tablas.PROPIEDADES ADD imagen_portada NVARCHAR(500) NULL;
        PRINT '✔️ Columna imagen_portada agregada a tablas.PROPIEDADES.';
    END
END
GO
...
BEGIN
    ...
    PRINT '✔️ Tabla tablas.IMAGENES creada.';
END
GO
...
BEGIN
    ...
    PRINT '✔️ Tabla tablas.FAVORITOS creada.';
END
GO
...
BEGIN
    ...
    PRINT '✔️ Tabla tablas.MENSAJES creada.';
END
GO
...
BEGIN
    ...
    PRINT '✔️ Tabla tablas.REPORTES creada.';
END
GO
...
BEGIN
    ...
    PRINT '✔️ Tabla tablas.AUDITORIA creada.';
END
GO
